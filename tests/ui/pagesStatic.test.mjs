...
test('GitHub Pages 用 LIFF 画面は必要スクリプトと要素を持つ', async () => {
  ...
  assert.match(html, /<link rel="stylesheet" href="\.\/style\.css\?v=stats-calendar-state-ui-20260425" \/>/);
  assert.match(html, /<script src="\.\/app\.js\?v=stats-calendar-state-ui-20260425" defer><\/script>/);
