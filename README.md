...
| `manager` | 店長・部署責任者 | 自店舗の当日チェックリスト閲覧、チェック、取消（自分が付けたチェックに加えて他人分を含む）、未完了一覧、履歴閲覧、手動通知、テンプレート管理 |
| `admin` | 本部担当者 | 初期版では単一店舗前提で、自店舗の当日チェックリスト閲覧、チェック、取消（自分が付けたチェックに加えて他人分を含む）、未完了一覧、履歴閲覧、手動通知、テンプレート管理 |
